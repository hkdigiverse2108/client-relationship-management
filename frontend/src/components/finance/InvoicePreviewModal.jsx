    ...
    <div className="modal show d-block" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
      <div className="modal-dialog modal-dialog-centered modal-xl">
        <div className="modal-content">
          <div className="modal-header border-bottom align-items-center">
            <h5 className="modal-title">Invoice Preview</h5>
            <div className="ms-auto me-3">
              <button className="btn btn-primary d-inline-flex align-items-center" onClick={handlePrint}>
                   ...
                   <table className="table table-sm table-borderless mb-0" style={{fontSize: '12px'}}>
                     <tbody>
                       <tr>
                         ...
                         <td className="fw-bold text-end pb-1">{invoice.invoice_number || invoice.invoiceId}</td>
                       </tr>
                       <tr>
                         <td className="text-muted pb-1">Date</td>
                         <td className="fw-bold text-end pb-1">{invoice.issue_date ? new Date(invoice.issue_date).toLocaleDateString() : 'N/A'}</td>
                       </tr>
                       <tr>
                  ...
                  <table className="table table-sm table-borderless" style={{fontSize: '12px'}}>
                    <tbody>
                      ...
                      {isCgst ? (
                        <>
                          <tr>
                            <td className="text-muted">Add: CGST @ {invoice.cgst_percent || 9}%</td>
                            <td className="text-end">{formatCurrency(cgstAmt)}</td>
                          </tr>
                          <tr className="border-bottom border-light">
                            <td className="text-muted">Add: SGST @ {invoice.sgst_percent || 9}%</td>
                            <td className="text-end">{formatCurrency(sgstAmt)}</td>
                          </tr>
                        </>
                      ) : (
                        <tr className="border-bottom border-light">
                          <td className="text-muted">Add: IGST @ {invoice.igst_percent || 18}%</td>
