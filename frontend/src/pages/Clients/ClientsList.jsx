  ...
  return (
    <>
      <PageHeader
        ...
        description="AManage business accounts, client project scopes, files, and billing records."
        actions={<Button icon={FiPlus} variant="gradient">Add New Client</Button>}
      />
