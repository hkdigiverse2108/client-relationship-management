...
const InvoiceModal = ({ isOpen, onClose, invoice, onSave }) => {
  ...
  return (
    <Modal
      open={isOpen}
      onClose={onClose}
      title={(invoice && (invoice.id || invoice._id)) ? "Edit Invoice" : "Create New Invoice"}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="col-12 border-top pt-4 mt-4 border-bottom pb-4 mb-4">
            <div className="form-check form-switch mb-3">
              ...
              <div className="form-text" style={{ color: 'var(--color-text-muted)' }}>System will automatically generate and save a new invoice based on frequency.</div>
            </div>
            
            {formData.is_recurring && (
              <div className="row g-3 p-3 rounded shadow-sm border border-secondary-subtle" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
        ...
        <div className="row mt-4">
          ...
          <div className="col-md-6">
             <div className="card border-0 shadow-sm" style={{ backgroundColor: 'var(--color-surface-alt)', color: 'var(--color-text)' }}>
                <div className="card-body">
                   
                   <div className="d-flex justify-content-between mb-3 text-muted">
                      <span className="fw-medium">Total Before Tax</span>
                      <span className="fw-bold">₹ {totals.totalBeforeTax.toFixed(2)}</span>
                   </div>
        ...
        <div className="d-flex justify-content-end gap-3 mt-4 pt-4 border-top">
          ...
          <Button variant="primary" type="submit" className="px-5 rounded-pill shadow-sm" isLoading={isSubmitting}>
            {(invoice && (invoice.id || invoice._id)) ? "Update Invoice" : "Save Invoice"}
          </Button>
        </div>
      </form>
    </Modal>
