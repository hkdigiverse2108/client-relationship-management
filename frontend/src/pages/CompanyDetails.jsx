			...
			<div className="content">
				...
				<div className="row align-items-center mb-4">
					<div className="col-sm-6">
						<h6 className="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a
								href="/companies-grid">
								<i className="ti ti-arrow-left me-2"></i>Companies</a>
							<span className="text-gray d-inline-flex ms-2">/ BrightWave Innovations</span>
						</h6>
					</div>
					<div className="col-sm-6">
						...
						<div className="card card-bg-1">
							<div className="card-body p-0">
								<span className="avatar avatar-xl border bg-white rounded-circle m-auto d-flex mb-2">
									<img src="/assets/img/company/company-11.svg" className="w-auto h-auto" alt="Img" />
								</span>
								<div className="text-center px-3 pb-3 border-bottom">
									<h5 className="d-flex align-items-center justify-content-center mb-1">BrightWave
										Innovations <i className="ti ti-discount-check-filled text-success ms-1"></i></h5>
									<p className="text-dark">1861 Bayonne Ave, Manchester, NJ, 08759</p>
								</div>
