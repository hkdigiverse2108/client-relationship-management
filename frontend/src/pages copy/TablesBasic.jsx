...
const TablesBasic = () => {
  // Pagination state for tablesbasic
  const [currentPage_tablesbasic, setCurrentPage_tablesbasic] = useState(1);
  const [rowsPerPage_tablesbasic, setRowsPerPage_tablesbasic] = useState(10);
  const [searchQuery_tablesbasic, setSearchQuery_tablesbasic] = useState('');
  return (
    <>
			...
			<div className="content">
				...
				<PageHeader 
					...
					breadcrumbs={[
						{ label: 'Dashboard' },
						{ label: 'Tables' },
						{ label: 'Tables Basic', active: true }
					]}
				>
								...
								<div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3 px-3 pt-3">
									<div className="d-flex align-items-center">
										...
										<select
											...
											value={rowsPerPage_tablesbasic}
											onChange={(e) => { setRowsPerPage_tablesbasic(Number(e.target.value)); setCurrentPage_tablesbasic(1); }}
										>
									...
									<div className="input-icon-start position-relative">
										...
										<input
											...
											placeholder="Search"
											value={searchQuery_tablesbasic}
											onChange={(e) => { setSearchQuery_tablesbasic(e.target.value); setCurrentPage_tablesbasic(1); }}
										/>
									</div>
								</div>
									...
									<table className="table mb-0">
										...
										<tbody>
											<tr>
												...
												<td><span className="badge rounded-pill badge-soft-success">Active</span>
												</td>
												<td>
													<div className="dropdown d-inline-block">
														<button type="button"
															...
															<i className="ti ti-dots-vertical fs-18 text-dark"></i>
														</button>
											...
											<tr>
												...
												<td><span className="badge rounded-pill badge-soft-danger">Inactive</span>
												</td>
												<td>
													<div className="dropdown d-inline-block">
														<button type="button"
				...
				<div className="row">
					...
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<p className="card-title-desc">Use one of two modifier classes to make
									...
									<table className="table mb-0">
										...
										<tbody>
											<tr>
												...
												<td>Mark</td>
												<td>Otto</td>
												<td><button type="button" className="btn btn-light btn-sm">View</button>
												</td>
											</tr>
											<tr>
												<th scope="row">2</th>
				...
				<div className="row">
												...
												<td>
													<div className="d-inline-flex gap-2">
														<a href="#" onClick={(e) => e.preventDefault()}
															className="btn btn-icon btn-sm btn-soft-success rounded-pill"><i
																className="ti ti-download"></i></a>
														<a href="#" onClick={(e) => e.preventDefault()}
															className="btn btn-icon btn-sm btn-soft-info rounded-pill"><i
					...
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<p className="card-title-desc"> Add <code>.table-borderless</code> for a table without
									borders.</p>
										...
										<tbody>
											<tr>
												...
												<td>
													<div className="d-inline-flex gap-2">
														<a href="#" onClick={(e) => e.preventDefault()}
															className="btn btn-icon btn-sm btn-light"><i
																className="ti ti-download"></i></a>
														<a href="#" onClick={(e) => e.preventDefault()}
															className="btn btn-icon btn-sm btn-light"><i
																className="ti ti-edit"></i></a>
										...
										<tbody>
											<tr>
												...
												<td>
													<div className="d-inline-flex gap-2">
														<a href="#" onClick={(e) => e.preventDefault()}
															className="btn btn-icon btn-sm btn-success"><i
																className="ti ti-download"></i></a>
														<a href="#" onClick={(e) => e.preventDefault()}
															className="btn btn-icon btn-sm btn-info"><i
																className="ti ti-edit"></i></a>
													</div>
												</td>
											</tr>
									...
									<table className="table table-bordered border-success mb-0">
										...
										<tbody>
											<tr>
												...
												<td>
													<button
														className="btn btn-sm btn-danger btn-wave waves-effect waves-light">
				...
				<div className="row">
					...
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<div className="table-responsive">
									<p className="card-title-desc">Table cells in <code>&lt;tbody&gt;</code> inherit their
					...
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<p className="card-title-desc"> Border styles, active styles, and table variants are not
				...
				<div className="row">
										...
										<tbody>
											<tr>
												...
												<td className="text-center text-muted">
													<a href="javascript: void(0);" className="link-reset fs-20 p-1"> <i
															className="ti ti-trash"></i></a>
												</td>
											</tr>
											<tr>
					...
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<p className="card-title-desc"> Add <code>.table-sm</code> to make tables more compact by
				...
				<div className="row">
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<p className="card-title-desc">Use contextual classes to color table rows or individual
									cells.</p>
					...
					<div className="col-xl-6">
						<div className="card">
							...
							<div className="card-body">
								<p className="card-title-desc">A <code>&lt;caption&gt;</code> functions like a heading for a
							...
							<div className="card-body">
									...
									<table className="table mb-0">
										...
										<tbody>
											<tr>
												...
												<td>
													<h6 className="mb-0 fs-14 fw-semibold">Cash on Delivery</h6>
												</td>
												<td><span
														className="badge badge-boxed  badge-outline-warning">Pending</span>
												</td>
												<td>
													<a href="javascript: void(0);" className="link-reset fs-18 p-1"> <i
								...
								<div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 px-3 py-3 border-top">
									<p className="mb-0 text-gray-9 fs-14">
										Showing {Math.min((currentPage_tablesbasic - 1) * rowsPerPage_tablesbasic + 1, 11)}-{Math.min(currentPage_tablesbasic * rowsPerPage_tablesbasic, 11)} of 11 entries
									</p>
									<ul className="pagination mb-0">
										<li className={`page-item ${currentPage_tablesbasic === 1 ? 'disabled' : ''}`}>
											<button className="page-link" onClick={() => setCurrentPage_tablesbasic(p => Math.max(p - 1, 1))}>
												<i className="ti ti-chevron-left"></i>
											</button>
										</li>
										{[1, 2].map(page => (
											<li key={page} className={`page-item ${currentPage_tablesbasic === page ? 'active' : ''}`}>
												<button className="page-link" onClick={() => setCurrentPage_tablesbasic(page)}>{page}</button>
											</li>
										))}
										<li className={`page-item ${currentPage_tablesbasic === 2 ? 'disabled' : ''}`}>
											<button className="page-link" onClick={() => setCurrentPage_tablesbasic(p => Math.min(p + 1, 2))}>
