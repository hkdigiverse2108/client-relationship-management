...
const TodoList = () => {
  // Pagination state for todolist
  const [currentPage_todolist, setCurrentPage_todolist] = useState(1);
  const [rowsPerPage_todolist, setRowsPerPage_todolist] = useState(10);
  const [searchQuery_todolist, setSearchQuery_todolist] = useState('');
  return (
    <>
			...
			<div className="content">
				...
				<div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					...
					<div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						<div className="d-flex align-items-center border rounded p-1 me-2">
							<a href="/todo-list" className="btn btn-icon btn-sm active bg-primary text-white"><i
									className="ti ti-list-tree"></i></a>
							<a href="/todo" className="btn btn-icon btn-sm"><i className="ti ti-table"></i></a>
						</div>
						<div className="">
							<a href="#" className="btn btn-primary d-flex align-items-center" data-bs-toggle="modal"
								data-bs-target="#add_todo"><i className="ti ti-circle-plus me-2"></i>Create New</a>
						</div>
				...
				<div className="card">
					...
					<div className="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
						<h5 className="d-flex align-items-center">Todo Lists <span className="badge bg-soft-pink ms-2">200
								Employees</span></h5>
						<div className="d-flex align-items-center flex-wrap row-gap-3">
							...
							<div className="dropdown me-2">
								...
								<ul className="dropdown-menu  dropdown-menu-end p-3">
									<li>
										<Link to="#" className="dropdown-item rounded-1">All Tags</Link>
									</li>
									<li>
										<Link to="#" className="dropdown-item rounded-1">Urgent</Link>
									</li>
									<li>
							...
							<div className="dropdown me-2">
								...
								<ul className="dropdown-menu  dropdown-menu-end p-3">
									<li>
										<Link to="#" className="dropdown-item rounded-1">Sophie</Link>
									</li>
									<li>
										<Link to="#" className="dropdown-item rounded-1">Cameron</Link>
									</li>
									<li>
										<Link to="#" className="dropdown-item rounded-1">Doris</Link>
									</li>
									<li>
										<Link to="#" className="dropdown-item rounded-1">Rufana</Link>
									</li>
								</ul>
							</div>
							<div className="dropdown me-2">
							...
							<div className="dropdown">
								...
								<ul className="dropdown-menu  dropdown-menu-end p-3">
									...
									<li>
										<Link to="#" className="dropdown-item rounded-1">Last 1 month</Link>
									</li>
									<li>
										<Link to="#" className="dropdown-item rounded-1">Last 1 year</Link>
									</li>
								</ul>
							</div>
						</div>
								...
								<div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3 px-3 pt-3">
									<div className="d-flex align-items-center">
										...
										<select
											...
											value={rowsPerPage_todolist}
											onChange={(e) => { setRowsPerPage_todolist(Number(e.target.value)); setCurrentPage_todolist(1); }}
										>
									...
									<div className="input-icon-start position-relative">
										...
										<input
											...
											placeholder="Search"
											value={searchQuery_todolist}
											onChange={(e) => { setSearchQuery_todolist(e.target.value); setCurrentPage_todolist(1); }}
										/>
									</div>
								</div>
							...
							<table className="table datatable">
								...
								<tbody>
									<tr>
										<td>
											<div className="d-flex align-items-center">
												...
												<span className="mx-2 d-flex align-items-center rating-select"><i
														className="ti ti-star"></i></span>
												<span className="d-flex align-items-center"><i
														className="ti ti-square-rounded text-danger me-2"></i></span>
											</div>
										</td>
										<td>
											<p className="fw-medium text-dark">Respond to any pending messages</p>
										</td>
										<td>
										...
										<td>
											<div className="d-flex align-items-center">
												<a href="#" className="btn btn-sm btn-icon" data-bs-toggle="modal"
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Update calendar and schedule</p>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Attend team meeting at 10:00 AM</p>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Check and respond to emails</p>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Coordinate with department head</p>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Plan tasks for the next day</p>
										</td>
										<td>
											<span className="badge badge-info">Social</span>
										</td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Finalize project proposal</p>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Submit to supervisor by EOD</p>
										</td>
										<td>
											<span className="badge badge-secondary">Reminder</span>
										</td>
									...
									<tr>
										...
										<td>
											<p className="fw-medium text-dark">Prepare presentation slides</p>
										</td>
										<td>
											<span className="badge bg-pink">Research</span>
										</td>
								...
								<div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 px-3 py-3 border-top">
									<p className="mb-0 text-gray-9 fs-14">
										Showing {Math.min((currentPage_todolist - 1) * rowsPerPage_todolist + 1, 11)}-{Math.min(currentPage_todolist * rowsPerPage_todolist, 11)} of 11 entries
									</p>
									<ul className="pagination mb-0">
										<li className={`page-item ${currentPage_todolist === 1 ? 'disabled' : ''}`}>
											<button className="page-link" onClick={() => setCurrentPage_todolist(p => Math.max(p - 1, 1))}>
												<i className="ti ti-chevron-left"></i>
											</button>
										</li>
										{[1, 2].map(page => (
											<li key={page} className={`page-item ${currentPage_todolist === page ? 'active' : ''}`}>
												<button className="page-link" onClick={() => setCurrentPage_todolist(page)}>{page}</button>
											</li>
										))}
										<li className={`page-item ${currentPage_todolist === 2 ? 'disabled' : ''}`}>
											<button className="page-link" onClick={() => setCurrentPage_todolist(p => Math.min(p + 1, 2))}>
