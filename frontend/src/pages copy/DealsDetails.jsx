			...
			<div className="content">
				...
				<PageHeader 
					...
					breadcrumbs={[
						{ label: 'Dashboard' },
						{ label: 'CRM' },
						{ label: 'Deals Details', active: true }
					]}
				>
				...
				<div className="row align-items-center row-gap-3 mb-4">
					<div className="col-sm-6">
						<div className="d-flex align-items-center flex-wrap row-gap-3">
							<h6 className="fw-medium d-inline-flex align-items-center me-2"><a href="/deals">
									<i className="ti ti-arrow-left me-2"></i>Deals</a>
								<span className="text-gray d-inline-flex ms-2">/ Website Redesign</span>
							</h6>
						...
						<div className="card card-bg-1">
							<div className="card-body p-0">
								...
								<div className="text-center px-3 pb-3 border-bottom">
									<h5 className="d-flex align-items-center justify-content-center mb-1">Website Redesign
									...
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="badge badge-success-transparent"><i
												className="ti ti-thumb-up me-1"></i>Won</span>
									</div>
								</div>
						...
						<div>
							<div className="bg-white rounded p-3 mb-3">
								...
								<div className="pipeline-list">
									<ul>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-purple">Quality To Buy</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-info">Contact Made</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-warning">Presentation</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-pink">Proposal Made</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()}>Appointment</a></li>
									</ul>
								</div>
