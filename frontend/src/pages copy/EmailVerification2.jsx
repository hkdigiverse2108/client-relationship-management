					...
					<div className="col-lg-7 col-md-12 col-sm-12">
						<div className="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
							<div className="col-md-7 mx-auto p-4">
								<form onSubmit={(e) => e.preventDefault()} className="digit-group">
									<div>
										...
										<div className="">
                                            <div className="text-center mb-3">
                                                <h2 className="mb-2">Email OTP Verification</h2>
                                                <p className="mb-0">Please enter the OTP received to confirm your account ownership. A code has been send to ******doe@example.com</p>
                                            </div>
                                            <div className="text-center otp-input">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="mb-3 d-flex justify-content-center">
                                                        <p className="text-gray-9">Didn't get the OTP? <a href="#" onClick={(e) => e.preventDefault()} className="text-primary">Resend OTP</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-3">
