			...
			<div className="content">
				...
				<PageHeader 
					...
					breadcrumbs={[
						...
						{ label: 'SMS Templates', active: true }
					]}
				>
								...
								<div className="d-flex flex-column list-group settings-list">
									...
									<a href="/sms-template"
										className="d-inline-flex align-items-center rounded active py-2 px-3"><i
											className="ti ti-arrow-badge-right me-2"></i>SMS Templates</a>
									<a href="/otp-settings"
							...
							<div className="card-body">
								<div className="border-bottom d-flex align-items-center justify-content-between pb-3 mb-3">
									...
									<a href="#" className="btn btn-primary" data-bs-toggle="modal"
										data-bs-target="#smstemplate"><i className="ti ti-circle-plus me-2"></i>Add
										Template</a>
								</div>
