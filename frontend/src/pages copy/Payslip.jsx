									...
									<div className="row justify-content-between align-items-center border-bottom mb-3">
										...
										<div className="col-md-6">
											<div className=" text-end mb-3">
												<h5 className="text-gray mb-1">Payslip No <span className="text-primary">
														#PS4283</span></h5>
												<p className="fw-medium">Salary Month : <span className="text-dark">October
														2024</span> </p>
											</div>
										</div>
									</div>
											...
											<div className="mb-3">
												...
												<div>
													...
													<p className="mb-1">Email : <span
															className="text-dark">xyztech@example.com</span></p>
										...
										<div className="col-md-5">
											<div className="mb-3">
												...
												<div>
													...
													<p className="mb-1">Email : <span
															className="text-dark">anthony@example.com</span></p>
													<p>Phone : <span className="text-dark">+1 458 268 4738</span></p>
												</div>
											</div>
										</div>
									</div>
									<div>
										<h5 className="text-center mb-4">Payslip for the moth of October 2024</h5>
										<div className="row">
											<div className="col-md-6">
												<div className="list-group mb-3">
													...
													<div className="list-group-item">
														<div className="d-flex align-items-center justify-content-between">
															<p className="mb-0">House Rent Allowance (H.R.A.)</p>
											...
											<div className="col-md-6">
												<div className="list-group mb-3">
													...
													<div className="list-group-item">
														<div className="d-flex align-items-center justify-content-between">
															<p className="mb-0">Tax Deducted at Source (T.D.S.)</p>
															<h6 className="fw-medium">$200</h6>
														</div>
													</div>
													<div className="list-group-item">
										...
										<div>
											<p>Net Salary : <span className="text-gray-9 fw-medium"> $3600(Three thousand
