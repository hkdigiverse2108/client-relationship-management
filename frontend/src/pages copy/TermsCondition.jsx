				...
				<div className="card">
					<div className="card-body pb-1">
						...
						<div className="mb-3">
							...
							<p className="mb-2">By using the HR Admin platform, you agree to be bound by these Terms and
						...
						<div>
							...
							<p className="mb-2">As an authorized user of the HR Admin platform, you agree to:</p>
							<ul className="list-styled mb-3">
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i> Ensure the confidentiality of your
									login credentials.
								</li>
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i> Use the platform solely for lawful HR
									administrative purposes.
								</li>
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i> Not share or disclose sensitive
									employee information unless authorized.
								</li>
								<li className="d-flex align-items-baseline">
									<i className="ti ti-point-filled fs-10 me-1"></i> Report any security breaches or
						...
						<div className="mb-3">
							...
							<p className="mb-2">The HR Admin platform allows you to manage employee data, review reports,
						...
						<div>
							...
							<ul className="list-styled mb-3">
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i> Access the platform for any unlawful
									purposes.
								</li>
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i> Use the platform to harass, defraud,
									or harm any individual or company.
								</li>
								<li className="d-flex align-items-baseline mb-2">
									<i className="ti ti-point-filled fs-10 me-1"></i> Reverse engineer, decompile, or
									attempt to extract the source code of the platform.
								</li>
								<li className="d-flex align-items-baseline">
									<i className="ti ti-point-filled fs-10 me-1"></i> Interfere with the platform’s
