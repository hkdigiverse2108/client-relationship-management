			...
			<div className="content">
				...
				<PageHeader 
					...
					breadcrumbs={[
						{ label: 'Dashboard' },
						{ label: 'CRM' },
						{ label: 'Leads Details', active: true }
					]}
				>
				...
				<div className="row align-items-center mb-4">
					<div className="col-sm-6">
						<div className="d-flex align-items-center flex-wrap row-gap-3">
							<h6 className="fw-medium d-inline-flex align-items-center me-2"><a href="/leads">
									<i className="ti ti-arrow-left me-2"></i>Leads</a>
							...
							<div className="dropdown">
								<a href="#" onClick={(e) => e.preventDefault()}
									...
									<i className="ti ti-git-branch me-1"></i>
									Marketing Pipeline
								</a>
								<ul className="dropdown-menu  dropdown-menu-end p-3">
									<li>
										<a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item rounded-1">Marketing
											Pipeline</a>
									</li>
									<li>
										<a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item rounded-1">Deal Pipeline</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div className="col-xl-4 theiaStickySidebar">
						<div className="card card-bg-1">
							<div className="card-body p-0">
								<span
									className="avatar avatar-xl border text-dark bg-white rounded-circle m-auto d-flex mb-2">
									JS
								</span>
								<div className="text-center px-3 pb-3 border-bottom">
									<h5 className="d-flex align-items-center justify-content-center mb-1">John Smith
										<span className="avatar avatar-sm avatar-rounded bg-light ms-2"><i
												className="ti ti-star-filled text-warning fs-14"></i></span>
									</h5>
									<p className="text-dark mb-1">1861 Bayonne Ave, Manchester, NJ, 08759</p>
									<p className="d-inline-flex align-items-center text-dark mb-2"><i
											className="ti ti-building me-1"></i>BrightWave Innovations</p>
									<div className="d-flex align-items-center justify-content-center">
										<span className="badge badge-dark-transparent me-2"><i
								...
								<div className="p-3 border-bottom">
									...
									<div className="d-flex align-items-center">
										<span className="badge badge-dark-transparent me-3">Devops Design</span>
										<span className="badge badge-dark-transparent">Material Design</span>
									</div>
								</div>
								<div className="p-3 border-bottom">
								...
								<div className="p-3">
									...
									<div className="d-flex align-items-center justify-content-between mb-2">
										...
										<p className="text-dark d-flex align-items-center">
											<span className="avatar avatar-sm avatar-rounded me-2"><img
						...
						<div>
							<div className="bg-white rounded p-3 mb-3">
								...
								<div className="pipeline-list pipeline-list-two">
									<ul>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-purple">Not Contacted</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-info">Contacted</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-warning">Closed</a></li>
										<li><a href="#" onClick={(e) => e.preventDefault()} className="bg-danger">Lost</a></li>
									</ul>
								</div>
