			...
			<div className="content">
				...
				<PageHeader 
					...
					breadcrumbs={[
						{ label: 'Dashboard' },
						{ label: 'Employee' },
						{ label: 'Tickets Grid', active: true }
					]}
				>
					<div className="me-2 mb-2">
							<div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
								<a href="/tickets" className="btn btn-icon btn-sm me-1"><i
										className="ti ti-list-tree"></i></a>
								<a href="/tickets-grid" className="btn btn-icon btn-sm active bg-primary text-white"><i
						...
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Laptop Issue</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 001</span>
								</div>
								<div className="d-flex flex-column">
									...
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Status</span>
										<span
											className="badge bg-pink-transparent d-inline-flex align-items-center fs-10 fw-medium">
											<i className="ti ti-circle-filled fs-5 me-1"></i>Open
										</span>
									</div>
									<div className="d-flex align-items-center justify-content-between">
										<span>Priority</span>
										<span
											className="badge bg-outline-secondary d-inline-flex align-items-center fs-10 fw-medium">
											<i className="ti ti-circle-filled fs-5 me-1"></i>Low
										</span>
									</div>
								</div>
								<div className="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
									...
									<div className="icons-social d-flex align-items-center">
										<a href="#"
											className="avatar avatar-rounded avatar-sm bg-primary-transparent me-2"><i
												className="ti ti-message text-primary"></i></a>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Payment Issue</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 002</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
									...
									<div className="d-flex align-items-center justify-content-between">
										<span>Priority</span>
										<span
											className="badge bg-outline-danger d-inline-flex align-items-center fs-10 fw-medium">
											<i className="ti ti-circle-filled fs-5 me-1"></i>High
										</span>
									</div>
								</div>
								<div className="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Bug Report</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 003</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Access Denied</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 004</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Display Glitch</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 005</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Security Alert</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 006</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Connectivity Issue</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 007</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Update Error</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 008</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Login Failure</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 009</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Server Timeout</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 010</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="card">
							<div className="card-body">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Email Client Setup</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 011</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
							...
							<div className="card-body">
								<div className="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="/ticket-details"
											className="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="/assets/img/users/user-56.jpg" className="img-fluid h-auto w-auto"
												alt="img" />
										</a>
									</div>
									<div className="dropdown">
								...
								<div className="text-center mb-3">
									<h6 className="mb-1"><a href="/ticket-details">Application Crashing</a></h6>
									<span className="badge bg-info-transparent fs-10 fw-medium">Tic - 012</span>
								</div>
								<div className="d-flex flex-column">
									<div className="d-flex align-items-center justify-content-between mb-3">
										<span>Category</span>
