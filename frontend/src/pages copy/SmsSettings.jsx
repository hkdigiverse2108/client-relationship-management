			...
			<div className="content">
				...
				<PageHeader 
					...
					breadcrumbs={[
						...
						{ label: 'SMS Settings', active: true }
					]}
				>
								...
								<div className="d-flex flex-column list-group settings-list">
									...
									<a href="/sms-settings"
										className="d-inline-flex align-items-center rounded active py-2 px-3"><i
											className="ti ti-arrow-badge-right me-2"></i>SMS Settings</a>
									<a href="/sms-template"
						...
						<div className="card">
							...
							<div className="card-body p-3">
														<div className="d-flex align-items-center justify-content-between">
															...
															<div className="d-flex align-items-center">
																<span>
																	<img src="/assets/img/settings/nexmo.svg"
																		alt="Profile" className="settings-img" />
																</span>
							...
							<div className="card-body p-3">
														<div className="d-flex align-items-center justify-content-between">
															<div className="d-flex align-items-center">
																<span>
																	<img src="/assets/img/settings/sms-gateway.svg"
																		alt="Profile" className="settings-img" />
																</span>
							...
							<div className="card-body p-3">
														<div className="d-flex align-items-center justify-content-between">
															<div className="d-flex align-items-center">
																<span>
																	<img src="/assets/img/settings/twilio.svg"
																		alt="Profile" className="settings-img" />
																</span>
